...
def run_prediction(cache_path="Predictions/cache_monaco"):
    ...
    # ----------------------------
    # Load all race data from first 7 races of 2025
    ...
    qual_2025 = pd.DataFrame({
        "Driver": [
            "NOR", "LEC", "PIA", "VER", "HAM", "ALB", "HAD", "ALO", "OCO", "LAW",
            "SAI", "TSU", "HUL", "ANT", "BOR", "BEA", "GAS", "STR", "COL", "RUS"
        ],
        "QualifyingTime (s)": [
            69.954, 70.063, 70.129, 70.669, 70.382, 70.732, 70.923, 70.924, 70.942, 71.129,
    ...
    plt.title("Feature Importance (Monaco GP Race Prediction)")
    plt.tight_layout()
    plt.show()
